...
then
        ...
        cp ~/data-cms/cms1 ~/data-backup/$datenow/
        cp /home/ubuntu/leafycampus/bg4-master/bg4/src/main/resources/Schema_resource.xml ~/data-cms/cms1/content/meta/meta-sc
hema/Schema-cms.xml
