package org.spo.svc4.trx.pgs.k01.task;
...
import org.spo.ifs4.dsl.model.AbstractTask;
import org.spo.svc4.trx.pgs.k01.handler.K01Handler;
import org.spo.svc4.trx.pgs.k01.toolkit.K01Toolkit;
...
import org.spo.svc4.trx.pgs.mdl.PageMeta;
import org.spo.svc4.trx.pgs.utils.GsonUtils;
import org.spo.svc4.trx.pgs.utils.MenuFactory;
import org.spo.svc4.trx.pgs.utils.SchemaQuery;
...
//		page.setSubTitle("Forum for Scholarship and Exploration");
		page.setSubTitle("Studio of Computer Design");//agency for minimalist software design
